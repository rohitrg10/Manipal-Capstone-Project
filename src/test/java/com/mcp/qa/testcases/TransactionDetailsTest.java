...
public class TransactionDetailsTest extends TestBase{
    ...
    public void testCustomerLoginFlow() {
    	customerLoginPage.transactionsflow(prop.getProperty("deposit1"),prop.getProperty("deposit2"),prop.getProperty("deposit3"),prop.getProperty("deposit4"),prop.getProperty("deposit5"),
